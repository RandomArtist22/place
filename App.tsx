...
const WS_URL = 'wss://dorathy-conceptional-yawnfully.ngrok-free.dev' ; // WebSocket server URL
    ...
    <div className="w-screen h-screen bg-gray-900 flex flex-col font-sans overflow-hidden relative">
      ...
      {isViewMode ? (
        ...
        <>
          ...
          <div id="cooldown-timer" className="absolute bottom-30 left-4 w-20 sm:w-24 text-center flex-shrink-0">
